...
export const codeErrorCls = codeCls + '-error';
export const codeLoadingCls = codeCls + '-loading';
export const codeThemeSwitcherCls = codeCls + '-theme-switcher';
export const codeThemeSwitcherCurrentCls = codeThemeSwitcherCls + '-current';
